...
if __name__ == "__main__":
    ...
    with torch.no_grad():
        ...
        schemes=[
            [0, 0, 0, 2, 1, 0, 0, 0, 0, 0, 0, 1, 0, 2, 0, 2, 0, 0, 0, 2, 2, 1, 0, 0, 0, 0, 0, 2, 1, 1, 0, 1, 0, 2, 1, 0, 2, 0, 0, 0, 0, 0, 0, 2],
            [1, 1, 3, 1, 1, 0, 0, 3, 1, 0, 3, 2, 1, 1, 1, 2, 0, 1, 0, 0, 1, 1, 0, 2, 0, 3, 3, 2, 1, 1, 0, 1, 0, 2, 1, 3, 2, 1, 0, 1, 0, 0, 0, 2],
            [1, 2, 3, 1, 2, 2, 0, 1, 1, 0, 3, 1, 1, 1, 1, 2, 0, 1, 0, 2, 2, 1, 0, 2, 2, 3, 3, 2, 1, 1, 0, 1, 0, 2, 1, 3, 2, 4, 0, 4, 0, 0, 0, 2],
            [2, 3, 3, 2, 4, 0, 0, 3, 2, 0, 3, 2, 1, 2, 0, 2, 2, 2, 4, 0, 2, 1, 0, 2, 0, 2, 3, 2, 1, 1, 0, 1, 0, 2, 1, 3, 2, 4, 0, 2, 0, 0, 0, 2],
            [2, 3, 3, 2, 4, 0, 0, 3, 3, 0, 0, 2, 1, 2, 3, 2, 0, 3, 3, 0, 2, 1, 0, 3, 0, 3, 3, 2, 1, 1, 0, 1, 0, 2, 1, 3, 2, 3, 0, 3, 0, 0, 0, 2],
            [2, 3, 3, 5, 4, 0, 0, 1, 4, 0, 3, 1, 1, 2, 0, 5, 5, 2, 4, 0, 5, 1, 0, 2, 0, 3, 3, 2, 1, 1, 0, 1, 0, 2, 1, 3, 2, 2, 0, 4, 0, 0, 0, 2],
            [3, 4, 3, 2, 2, 0, 0, 3, 4, 0, 0, 2, 1, 4, 4, 2, 0, 1, 0, 2, 2, 1, 0, 2, 0, 3, 3, 2, 1, 1, 0, 1, 0, 2, 2, 3, 2, 2, 0, 4, 0, 0, 0, 2],
            [4, 2, 3, 5, 2, 2, 0, 3, 4, 0, 0, 2, 1, 4, 4, 2, 0, 1, 0, 2, 2, 1, 0, 3, 0, 3, 2, 2, 1, 1, 0, 1, 0, 2, 1, 3, 2, 4, 0, 4, 0, 0, 0, 2],
            [4, 3, 3, 5, 4, 0, 0, 3, 4, 0, 3, 1, 1, 4, 4, 2, 0, 1, 0, 0, 5, 1, 0, 2, 0, 3, 3, 2, 1, 1, 0, 1, 0, 2, 1, 3, 2, 4, 0, 4, 0, 0, 0, 2],
            [4, 3, 3, 5, 2, 0, 0, 3, 4, 0, 0, 2, 1, 4, 4, 2, 0, 4, 0, 2, 2, 1, 0, 3, 0, 3, 3, 2, 1, 1, 0, 1, 0, 2, 1, 3, 2, 4, 0, 4, 0, 0, 0, 2],
        ]
        flop_list=[]
        acc_list=[]
        for si in schemes:
            model,edge_layer_map=searcher.model_reduce(si)
            ...
            flops=profile(eA, inputs=(torch.randn(2, 3, 224, 224).to(device),), verbose=False)[0]
            flop_list.append(flops)
            acc_list.append(loss)
        flops_normal=[(flops-min(flop_list))/(max(flop_list)-min(flop_list)) for flops in flop_list]
        acc_normal=[(acc-min(acc_list))/(max(acc_list)-min(acc_list)) for acc in acc_list]
        np.savez('./alpha_test.npz', 
                 flops=flops_normal,
                 acc=acc_normal)
