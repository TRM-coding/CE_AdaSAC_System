...
void VIEW_4D(
    ...
    ggml_context *ctx)
{
    out = ggml_view_4d(ctx,input,ne0,ne1,ne2,ne3,input->nb[0],input->nb[1],input->nb[2],offset);
    return;
}
    ...
    OPS_INFO &info)
{
    ...
    VIEW_4D(src, out, view_axes[0],view_axes[1],view_axes[2],view_axes[3], 0, ctx);
